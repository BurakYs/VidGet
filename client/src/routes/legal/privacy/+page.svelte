...
<div class="policy">
    ...
    <p>We do not store any personal data. However, we may temporarily log your IP address for the purposes of monitoring
    ...
    <p>Our Service may contain links to external sites that are not operated by us. We have no control over the content
        and practices of these sites, and cannot accept responsibility or liability for their respective privacy
        policies.</p>

    <h2>6. Changes to This Privacy Policy</h2>
    <p>We reserve the right to update our Privacy Policy at any time. We will not notify you directly of any changes. We
